...
// This component now includes all icons used across the application to ensure stability.
export const Icon: React.FC<IconProps> = ({ icon, ...props }) => {
  switch (icon) {
    ...
    case 'rocket':
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
                <path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.3.05-3.05-.62-.72-2.3-1.66-3.05-2.5" />
                <path d="m14 5-3 3 3 3 3-3-3-3z" />
                <path d="M9 14l-3 3" />
                <path d="m22 2-3 3" />
                <path d="M3 3l3 3" />
                <path d="M5 14l6.02-6.02c.55-.55.55-1.44 0-1.98s-1.44-.55-1.98 0L3 12" />
            </svg>
        );
    case 'fire':
        return (
    ...
    case 'idea':
        return (
             <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M12 2.69l.34 3.03.1.89H16.5l-2.5 1.8-.7.5.27 1.03 1.25 4.75L12 17.3l-2.82 2.05 1.25-4.75.27-1.03-.7-.5-2.5-1.8H11.56l.1-.89L12 2.69zM3.46 12l.69 3.03.1.89H8.25l-2.5 1.8-.7.5.27 1.03 1.25 4.75L4 19.3l-2.82 2.05 1.25-4.75.27-1.03-.7-.5-2.5-1.8H3.46zM20.54 12l.69 3.03.1.89h4.01l-2.5 1.8-.7.5.27 1.03 1.25 4.75L20 19.3l-2.82 2.05 1.25-4.75.27-1.03-.7-.5-2.5-1.8h4.01z" /></svg>
        );
    case 'profile':
        return (
    ...
    case 'receipt':
        return (
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z"/><path d="M16 8h-6a2 2 0 1 0 0 4h6"/><path d="M12 14v-4"/></svg>
        );
    case 'wallet':
        return (
    ...
    default:
      // Return a placeholder for any unrecognized icon
      return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
